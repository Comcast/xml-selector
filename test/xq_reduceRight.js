...
/**
 * Unit tests for the reduceRight() method
 */
...
module.exports.testEmpty = function(test) {
  test.strictEqual($$().reduceRight(function(memo, n) { return memo+1; }, 0), 0);
...
module.exports.testSuccess = function(test) {
  ...
  test.strictEqual($doc.reduceRight(function(memo, elem) {
...
module.exports.testContext = function(test) {
  ...
  test.strictEqual($$('<doc/>').reduceRight(function(memo, n) {
    out.push(this);
    return memo + 1;
  }, 0, ctx), 1);
...
module.exports.testArgs = function(test) {
  ...
  test.strictEqual($doc.reduceRight(function(memo, elem, idx, list) {
