...
/**
 * Unit tests for the some() method
 */
...
module.exports.testEmpty = function(test) {
  test.strictEqual($$().some(function() { return true; }), false);
...
module.exports.testFailure = function(test) {
  ...
  test.strictEqual($doc.some(function(elem) {
...
module.exports.testArgs = function(test) {
  ...
  test.strictEqual($doc.some(function(elem, idx, list) {
